...
/**
 * Elementor nvisor provide Widget.
 *
 * Elementor widget that inserts an embbedable content into the page, from any given URL.
 *
 * @since 1.0.0
 */
class Elementor_nvisor_provide_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Provide Section', 'nvisor-core' );
    }
    ...
    protected function render() {
        ...
        $provide_output = $this->get_settings_for_display(); ?>
    ...
    <div class="container-fluid p-0">
        <div class="provide-area">
            <div class="video-section">
                <img class="video-images" src="<?php echo esc_url($provide_output['bgimg']['url']); ?>" alt="Video" />
                <div class="video-iconarea">
                    <a class="venobox popup-videos-button" data-autoplay="true" data-vbtype="video" href="<?php echo esc_url($provide_output['ytlink']['url']); ?>">
            ...
            <div class="provide-content">
                <h2 class="st-title"><?php echo esc_html($provide_output['title']); ?></h2>
                <p><?php echo esc_html($provide_output['des']); ?></p>
                <?php 
            if(!empty($provide_output['list1'])):
            foreach ($provide_output['list1'] as $provide_slider):?>   
                <div class="provide-check-list">
                    ...
                    <div class="provide-text">
                        <h4><?php echo esc_html($provide_slider['p_title']); ?></h4>
                        <p><?php echo esc_html($provide_slider['p_des']); ?></p>
                    </div>
                </div>
                <?php endforeach; endif;?>
                <?php if(!empty($service2_output['bttext'] )): ?>
                <div class="provide-button">
                    <a class="theme-btn-one" href="<?php echo esc_url($provide_output['btlink']['url']); ?>"><span><?php echo esc_html($provide_output['bttext']); ?></span></a>
                </div>
                <?php endif;?>
            </div>
        </div>
